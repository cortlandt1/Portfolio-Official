...
//   <text text-anchor="start" x="10" y="30" className="text text-stroke" clip-path="url(#text1)">Where</text>
//   <text text-anchor="start" x="10" y="50" className="text text-stroke" clip-path="url(#text2)">Ideas</text>
//   <text text-anchor="start" x="10" y="70" className="text text-stroke" clip-path="url(#text3)">Begin.</text>
//   <text text-anchor="start" x="10" y="30" className="text text-stroke text-stroke-2" clip-path="url(#text1)">Where</text>
//   <text text-anchor="start" x="10" y="50" className="text text-stroke text-stroke-2" clip-path="url(#text2)">Ideas</text>
//   <text text-anchor="start" x="10" y="70" className="text text-stroke text-stroke-2" clip-path="url(#text3)">Begin.</text>
//   <defs>
//     <clipPath id="text1">
